  ...
  <div class="row">
    <div class="span3 sidebar">
      <ul class="well2 nav nav-list sidenav" data-spy="affix" data-offset-bottom="300">
          ...
          <li><a href="#circles">Making Circles</a></li>
          ...
          <li><a href="#inimg">Images in Boxes</a></li>
          <li><a href="#reimg">Resizing Images</a></li>
...
<div id="inimg" class="row-fluid">
<h3>Images in Boxes</h3>

</div>

<div id="reimg" class="row-fluid">
